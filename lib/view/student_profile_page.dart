...
class _StudentProfilePageState extends State<StudentProfilePage> {
  ...
  Future<void> _fetchCompleteProfile() async {
    try {
      ...
      var personalRequest = http.post(
        Uri.parse('https://schoolapp-api-dev.zeabur.app/api/student/student-info/personal'),
        headers: {'Authorization': 'Bearer $token', 'Content-Type': 'application/json'},
        body: exactPayload,
      );

      var detailRequest = http.post(
        Uri.parse('https://schoolapp-api-dev.zeabur.app/api/student/student-info/detail'),
        headers: {'Authorization': 'Bearer $token', 'Content-Type': 'application/json'},
        body: exactPayload,
      );
      ...
      print("🕵️‍♂️ [SADAP PERSONAL] Status: ${personalRes.statusCode} | Body: ${personalRes.body}");
      print("🕵️‍♂️ [SADAP DETAIL] Status: ${detailRes.statusCode} | Body: ${detailRes.body}");
        ...
        setState(() {
          if (personalRes.statusCode == 200) {
            ...
            if (decodedPersonal['data'] != null) {
              ...
              _bornDateController.text = rawDate.isNotEmpty ? rawDate.split('T')[0] : '';
              ...
              _schoolOriginController.text = personalData['schoolorigin_code']?.toString() ?? '';
  ...
  Widget build(BuildContext context) {
    ...
    if (photoUrl.isEmpty) photoUrl = 'https://i.pravatar.cc/150?u=${widget.studentData['nis']}';

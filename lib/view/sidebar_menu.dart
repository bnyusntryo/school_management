...
class _SidebarMenuState extends State<SidebarMenu> {
  ...
  final Color _textColor = const Color(
    0xFF334155,
  ); // Warna abu-abu gelap kebiruan elegan
  ...
  Widget _buildExpandableMenuItem({
    ...
    return Theme(
      data: Theme.of(context).copyWith(
        dividerColor:
            Colors.transparent, // Hilangkan garis border bawaan ExpansionTile
      ),
      child: ExpansionTile(
          ...
          return Padding(
            ...
            child: ListTile(
              ...
              visualDensity: const VisualDensity(
                vertical: -2,
              ), // Merapatkan jarak antar submenu
  ...
  void _handleSubMenuNavigation(String subMenu) {
    ...
    // E-Learning
      ...
      /* TODO: Halaman E-Learning Report */
    }
  }
}
